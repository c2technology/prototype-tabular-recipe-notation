...
1. Test against 10-20 recipe sites and capture failures in `docs/findings/` or GitHub issues.
2. Add schema.org Recipe JSON-LD extraction if a lightweight static-compatible source is found.
3. Add user-editable ingredient/step correction before rendering.
4. Explore more expressive TRN symbols for timing, equipment, heat level, and parallel prep.
5. Add PNG export if SVG download is not enough for sharing.
